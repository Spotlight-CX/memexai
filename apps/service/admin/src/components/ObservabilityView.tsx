      ...
      <Stack gap="md" p="lg" maw={1440} mx="auto">
        ...
        <Paper withBorder radius="sm" p="sm">
          <SimpleGrid cols={{ base: 1, sm: 2, md: 3, xl: 6 }} spacing="xs">
            ...
            <Select size="xs" label="Tool" placeholder="Any" clearable value={filters.toolName || null} onChange={(value) => setFilters((current) => ({ ...current, toolName: value ?? "" }))} data={["memory_list", "memory_read", "memory_write", "memory_patch", "memory_find", "memory_context", "memory_remember"]} />
            <Select size="xs" label="Operation" placeholder="Any" clearable value={filters.operation || null} onChange={(value) => setFilters((current) => ({ ...current, operation: value ?? "" }))} data={["list", "read", "write", "patch", "find", "context", "remember"]} />
