import { Box, Button, Paper, PasswordInput, Stack, Text, Title, Tooltip, ActionIcon, Group } from "@mantine/core"
  ...
  return (
    <Box
      ...
      style={{
        ...
        padding: 20,
        background: `radial-gradient(1000px circle at ${mousePos.x}px ${mousePos.y}px, rgba(45, 200, 150, 0.05), transparent 40%)`,
      }}
    >
      <Paper
        withBorder
