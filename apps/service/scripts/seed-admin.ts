...
const files: SeedFile[] = [
  {
    ...
    content: [
      "# Memory Guide",
      "",
      "This is the root of the memory system. Read this before writing to understand structure and conventions.",
      "",
      "## Spaces",
      "",
      "- `shared/` — read-only. Product-wide rules and context that apply to every user. You cannot write here.",
      "- `user/` — your personal writable memory space. Scoped to you; other users cannot see it.",
      "",
      "## Shared memory",
      "",
      "- `shared/index.md` — this file. System orientation.",
      "",
      "## Your memory space",
      "",
      "Use `user/` to store durable facts about this user. Suggested structure:",
      "",
      "- `user/index.md` — your table of contents; update it when you create new files or headings",
      "- `user/profile.md` — stable preferences, demographics, goals",
      "- `user/shortlist.md` — active shortlist of items",
      "- `user/preferences/` — detailed preference files by topic (commute, schools, budget, etc.)",
      "",
      "## Writing guidelines",
      "",
      "- Write stable, durable facts — not raw conversation transcripts",
      "- One heading per topic; patch to append, don't overwrite unnecessarily",
      "- Keep entries concise — one clear sentence beats a paragraph",
      "- Always update `user/index.md` when you create a new file",
    ].join("\n"),
    actor: "system",
    userId: null,
    reason: "Seed shared memory guide",
  },
  {
