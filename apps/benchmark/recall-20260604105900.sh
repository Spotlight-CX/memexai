#!/usr/bin/env bash
# Recall-only eval for run 20260604105900.
#
# Usage:
#   ./apps/benchmark/recall-20260604105900.sh
#
# Steps performed:
...
DUMP_FILE="$SCRIPT_DIR/data/memex-ingested-20260604105900.pgdump"
