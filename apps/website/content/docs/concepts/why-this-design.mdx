...
| Loading too much memory degrades output quality | Full file dumped into the prompt | Context budget in prompt block assembly; `memory_context` respects a character limit |
