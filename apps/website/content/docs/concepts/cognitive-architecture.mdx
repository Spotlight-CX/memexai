...
`shared/` files are global and visible to every agent session. `user/` files are private to a specific user. See [Memory Scopes](/docs/concepts/scopes) for the full path model.
...
- [Quickstart: Docker service](/docs/quickstart/docker-service)
