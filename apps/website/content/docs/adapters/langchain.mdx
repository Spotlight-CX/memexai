...
The Python adapter exposes all seven memory tools: `memory_list`, `memory_read`, `memory_write`, `memory_patch`, `memory_smart_read`, `memory_search`, and `memory_memorize`.
