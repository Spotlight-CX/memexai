...
- [Service mode (hot + background)](https://github.com/Spotlight-CX/memexai/tree/main/examples/anthropic-service) — `@memexai/sdk` + Anthropic SDK
- [Direct Postgres mode (hot + background)](https://github.com/Spotlight-CX/memexai/tree/main/examples/anthropic) — `@memexai/core` + Anthropic SDK

The Anthropic SDK adapter is TypeScript-only. For Python, use the [LangChain adapter](/docs/adapters/langchain) or the [Google ADK adapter](/docs/adapters/adk) which have first-party Python support.
