...
Use `@memexai/core` when your app owns the Postgres connection directly.
...
- [Service mode (hot + background)](https://github.com/Spotlight-CX/memexai/tree/main/examples/vercel-ai-service) — `@memexai/sdk` + Vercel AI SDK
- [Direct Postgres mode (hot + background)](https://github.com/Spotlight-CX/memexai/tree/main/examples/vercel-ai) — `@memexai/core` + Vercel AI SDK
