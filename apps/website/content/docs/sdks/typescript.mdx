...
description: Use @memexai/sdk for the HTTP service or @memexai/core for direct Postgres.
---

MemexAI has two TypeScript packages:

- `@memexai/sdk` talks to the HTTP service.
- `@memexai/core` talks directly to Postgres.
