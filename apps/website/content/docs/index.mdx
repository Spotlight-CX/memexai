...
Give the model `memory_memorize` and `memory_search`; MemexAI decides what is durable, searches memory, and handles file bookkeeping. Use this for most assistants.
